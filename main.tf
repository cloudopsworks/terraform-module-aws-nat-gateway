...
resource "aws_nat_gateway" "public" {
  count                          = var.nat_settings.connectivity_type == "public" ? length(var.nat_settings.allocation_ids) : 0
...
resource "aws_nat_gateway" "private" {
  count                              = var.nat_settings.connectivity_type == "private" ? length(var.nat_settings.private_ips) : 0
  connectivity_type                  = var.nat_settings.connectivity_type
